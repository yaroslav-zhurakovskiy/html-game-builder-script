/**
 * Module description
 * @moduleName PotUnlockedDialog
 * @snippet PotUnlockedDialog.snippet
PotUnlockedDialog({
    potSkin: ''
})
 */
bento.define('ui/potunlockeddialog', [
    'bento',
    'bento/math/vector2',
    ...
    return function (settings) {
        ...
        var doAnother = Utils.isDefined(settings.doAnother) ? settings.doAnother : false;
            ...
            onClick: function () {
                if (doAnother && Ads.canShowRewarded() && nextPotSkin) {
                    EventSystem.fire('GameAnalytics-addDesignEvent', {
                        eventId: "ads:rewardedSkinUnlockMenuDoAnother",
                        value: 0
                    });
                }
                dialog.close();
        ...
        var dialog = new Dialog({
            titleText: settings.titleText || Localization.getText('newPot'),
            type: '',

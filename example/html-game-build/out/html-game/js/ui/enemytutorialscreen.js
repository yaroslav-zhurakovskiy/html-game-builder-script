/**
 * Module description
 * @moduleName EnemyTutorial
 * @snippet EnemyTutorial.snippet
EnemyTutorial({
    position: new Vector2(0, 0)
})
 */
bento.define('ui/enemytutorialscreen', [
    'bento',
    'bento/math/vector2',
    ...
    return function (settings) {
        ...
        var promptCutscene = new Cutscene({
            cutsceneStrings: [Localization.getText('bzzt'), Localization.getText('tutorial3')],
            fontSize: 12,
            hideAfter: -1,
            yPos: 96,
            doAttach: false

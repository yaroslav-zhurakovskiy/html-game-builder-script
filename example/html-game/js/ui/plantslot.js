/**
 * A selectable plant skin
 * @moduleName PlantSlot
 * @snippet PlantSlot.snippet
PlantSlot({
    plantslot: plantslot,
    onClick: function () {}
})
 */
bento.define('ui/plantslot', [
    'bento',
    'bento/math/vector2',
    ...
    return function (settings) {
        ...
        var isVipCharacter = settings.isVipCharacter || false
        ...
        var slot = new Entity({
            ...
            components: [
                new SpriteContainer({
                    ...
                    imageName: isVipCharacter ? 'ui/char-back-vip' : 'ui/char-back-unlocked',
                    originRelative: new Vector2(0.5, 0.5),
